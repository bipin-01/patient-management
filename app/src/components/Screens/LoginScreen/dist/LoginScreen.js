...
var LoginScreen = function () {
    ...
    var loading = userLogin.loading, error = userLogin.error, userInfo = userLogin.userInfo;
    ...
    var submitHandler = function (e) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            e.preventDefault();
            dispatch(userAction_1.login(email, password));
            return [2 /*return*/];
        });
    }); };
    return (react_1["default"].createElement(MainScreen_1["default"], { title: 'LOGIN' },
        react_1["default"].createElement("div", { className: 'loginContainer' },
            error && react_1["default"].createElement(ErrorMessage_1["default"], { variant: 'danger' },
                error,
                " "),
